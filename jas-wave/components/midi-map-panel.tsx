/**
 * MIDI Learn: pantalla de workspace (no diálogo).
 * Asigna nota, CC o tecla a una función del DAW.
 */
    ...
    <div className="flex h-full min-h-0 flex-col bg-panel">
      <div className="flex items-center gap-3 border-b border-border px-4 py-3">
        ...
        <div className="min-w-0 flex-1">
          <h2 className="text-sm font-semibold text-foreground">MIDI Learn</h2>
          <p className="text-[11px] text-muted-foreground">
            Elige una función, pulsa Escuchar MIDI y toca una nota, tecla o control. Esta pantalla
            se puede desacoplar a otra ventana.
          </p>
        </div>
      </div>
      ...
      {deviceHint ? (
        ...
        <div className="border-b border-border px-4 py-1.5 text-[11px] text-muted-foreground">
          M-VAVE SMC-MIXER: ponlo en modo CC (User) y aplica el preset. Ctrl+Shift+M abre esta
          pantalla. Puedes desacoplarla desde la pestaña.
        </div>
      )}
